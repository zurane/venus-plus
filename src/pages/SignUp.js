            ...
            <Formik
              ...
              validate={(values) => {
                ...
                if (values.name.length < 3) {
                  errors.name = "Please enter your full names";
                }
                if (!values.email) {
                  errors.email =
            ...
            >
              {({
                ...
                >
                  ...
                  <input
                    className="block py-5 px-1 w-96 bg-transparent border-b border-white/20 text-white/50 text-md mb-2 focus:outline-none focus:ring-0 focus:border-blue-500"
