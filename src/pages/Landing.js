      ...
      >
        <nav className="flex flex-row items-center justify-between">
          ...
          <div className="flex flex-row items-center gap-5">
            ...
            <button className="rounded-full border px-10 py-2 font-BeVietnam font-bold text-white my-3">
              Sign in
            </button>
          </div>
        </nav>
        <div className="absolute bottom-32">
          ...
          <button className="flex items-center gap-3 rounded-full shadow-md inset-shadow-sm shadow-blue-500/20 bg-gradient-to-r from-[#095ae6] to-[#062794] px-9 py-3 font-BeVietnam font-bold text-white my-3">
            Start Tracking Free
            <PiCaretRightBold />
          </button>
        </div>
